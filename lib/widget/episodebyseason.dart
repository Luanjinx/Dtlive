...
class _EpisodeBySeasonState extends State<EpisodeBySeason> {
  ...
  Future<void> _checkAndDownload({required int position}) async {
    ...
    String v320 = episode?.video320 ?? "";
    String v480 = episode?.video480 ?? "";
    String v720 = episode?.video720 ?? "";
    String v1080 = episode?.video1080 ?? "";
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _buildMethodOption(context, "Internal Download", "Download inside the app", false, position, episode, v320, v480, v720, v1080),
                    _buildMethodOption(context, "External Download", "Download via Browser", true, position, episode, v320, v480, v720, v1080),
                  ],
                ),
              ),
            ],
  ...
  Widget _buildMethodOption(BuildContext context, String title, String subtitle, bool isExternal, int position, var episode, String v320, String v480, String v720, String v1080) {
    return InkWell(
      onTap: () {
        Navigator.pop(context);
        _showResolutionBottomSheet(isExternal, position, episode, v320, v480, v720, v1080);
      },
      child: Container(
  ...
  void _showResolutionBottomSheet(bool isExternal, int position, var episode, String v320, String v480, String v720, String v1080) {
    showModalBottomSheet(
      context: context,
      backgroundColor: lightBlack,
      isScrollControlled: true,
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  const SizedBox(height: 20),
                  if (v320.isNotEmpty) _buildQualityOption(context, "320p", "Low", v320, position, episode, isExternal),
                  if (v480.isNotEmpty) _buildQualityOption(context, "480p", "Standard", v480, position, episode, isExternal),
                  if (v720.isNotEmpty) _buildQualityOption(context, "720p", "HD", v720, position, episode, isExternal),
                  if (v1080.isNotEmpty) _buildQualityOption(context, "1080p", "Full HD", v1080, position, episode, isExternal),
                ],
              ),
            ),
          ],
  ...
  Widget _buildQualityOption(BuildContext context, String title, String subtitle, String url, int position, var episode, bool isExternal) {
    return InkWell(
      onTap: () async {
        Navigator.pop(context);
        if (isExternal) {
